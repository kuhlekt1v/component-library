...
import { Card, FormItem, PrimaryButton, ErrorMessage } from '../Styles/StyledComponents';
...
export const RegisterPage = () => {
  ...
  return (
    <>
      <Card>
        <form onSubmit={handleSubmit(onSubmit)} style={{ backgroundColor: 'transparent' }}>
          ...
          <FormItem>
            ...
            />
            {errors.username && errors.username.type === 'required' && <ErrorMessage>Username required.</ErrorMessage>}
          </FormItem>
          <FormItem>
            ...
            />
            {errors.password && errors.password.type === 'required' && <ErrorMessage>Password required.</ErrorMessage>}
          </FormItem>
          <FormItem>
